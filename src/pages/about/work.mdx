...
I am a web developer and agile practitioner with a diverse background in engineering and
management. I have been coding, leading, mentoring and facilitating for almost 30 years.
...
I moved to _London in 2011_, worked 4 years at **[EF Education First](https://ef.com)**, then as the Head of Frontend at **[Property Partner (now London House Exchange)](https://londonhouseexchange.com)**, and as Agile Delivery Manager at **[Nexmo (now Vonage)](https://vonage.com)**.

I arrived in _Barcelona in 2017_. Taught Web Development at **[Ironhack coding school](https://ironhack.com)**, having had _ninety three!_ students in little over a year. Since then, I worked briefly for **[Thoughtworks](https://www.thoughtworks.com/)**, two years for **[New Relic](https://newrelic.com)**, and another two at [Preply](https://preply.com).
...
At **[Preply](https://preply.com)**, as Technical Product Owner for the Design System initiative,defined the rollout strategy and technical roadmap, as well as the governance and contribution models, advocating for system adoption through leadership engagement and strategy workshops, and establishing transparent tracking of goals and progress.

As the Technical Leader, drove architectural decisions trough a series of RFCs, and developed the initial prototypes of libraries and tools, including instrumentation to track component adoption throughout the company's codebase. The system was built with a _design tokens first_ approach, focused on streamlining the authoring experience and automating the generation of documentation and code artefacts, enabling cross-platform distribution of themes, tokens, and deprecation notices.

Enabled adopters to become contributors, through training sessions and community building across the design and engineering crafts, supported by high quality guidelines and runbooks and continuous feedback loops.

System adoption improved user experience, ensuring design consistency, and enhancing accessibility and performance across all platforms, leading to significant business results, measurable through A/B experiments conducted throughout the rollout. Adoption contributed also to significant cycle time improvements, streamlining design operations and development experience, and ultimately enabled the company to fully rebrand all frontend and mobile applications in only a couple of months.

<Year y="2019-2021" />

As a lead developer, at **[New Relic](https://newrelic.com)**, developing and maintaining a very large frontend code base, within the world’s biggest [observability platform](https://newrelic.com/platform), mentoring other engineers in XP practices, requirements gathering, analysis and technical writing, architecture, design patterns, frontend development, web standards and browser APIs.
...
At **[Ironhack](https://www.ironhack.com/)** as Lead Teacher for the Web Development bootcamp in Barcelona, _teaching full-stack web development_ - concepts, hacks and best practices - and sharing the love for _Agile values and practices_.
...
Guided the team towards a more mature Scrum, and gradually introducing TDD, pairing, code reviews, Git flow, an _automated styleguide_ and CI practices, as well as facilitating _meaningful retrospectives and actionable insights_. Together, we grew to _deliver at a constant and sustainable pace_, releasing code to production every other day.
...
Moved to London in 2011 as the first backend developer of a greenfield project within **[EF - Education First](https://ef.com)**. The prototypes evolved into field tests, and the tests evolved into a mature platform. And the role evolved into _Tech Lead_.

The platform runs at a _global scale_ delivering [free online english tests](https://www.efset.org/) to millions of users, assisting teachers in dozens of schools, and supporting the research behind the [world's largest ranking of countries by English skills](https://www.ef.co.uk/epi/).

Also super proud to have helped building EF Class (seems to be now retired), an innovative _EdTech_ product that helped teachers run engaging, interactive, and motivational lessons.

#### Lisbon, Portugal

<Year y="2010" />

My last year in Portugal was spent _working with friends_ at **[Quodis](https://quodis.com/)**, a company of five, including some of the best UX / designers out there.
...
Since then, regardless of my role as a contributor, lead or manager, I have been integrating valuable lessons about _commitment, mindfulness, courage, respect and vulnerability_ and growing as facilitator and coach.

<Year y="2008" />

When I landed a web-developer role at Portugal Telecom's **[SAPO / Portugal Telecom](https://sapo.pt)** portal I knew I had done something right. It was a superb opportunity to _learn from the best_ engineers in Portugal at the time, and to have access to _web at scale_ projects and mature tech.
...
The [WHATWG](https://en.wikipedia.org/wiki/WHATWG) was rising, Firefox was launching. I was dreaming about a better web again and wanting to work full-time with web technologies.
...
the business plan went beyond being a vendor and an integrator. We were also _building prototypes for our own product_, using Delphi, rudimentary electronics, and lots of creative glue. So we sold one, then two, then five. The product was viable, the demand was there.

<Year y="1999-2000" />

Me and some friends created our own web-shop, _developed a CMS in PHP3_, streamlined a sales+delivery pipeline and went on to create websites for dozens of companies and institutions.
...
I was finishing university and creating my first _personal website_. The browsers at the time? [Navigator](https://en.wikipedia.org/wiki/Netscape#Early_years) and [IE2](https://en.wikipedia.org/wiki/Internet_Explorer_2). And dial-up bandwidth. On a good day, 30 kbps.

[My story with computers goes way back](/about/story).
...
I am lucky to have had the chance of working in _remarkable teams_. It has been an absolute _privilege and pleasure_ to work alongside so many talented and inspiring individuals: business people, academics, engineers, and artists.

Particularly, the ones I had the even greater privilege of mentoring along the way. You all rock! And you will rule!

### Next

You can learn more about my work in my [LinkedIn profile](https://linkedin.com/in/andretorgal).
