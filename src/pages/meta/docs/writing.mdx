...
If it sounds like _not me, not André Torgal_ or _andrezero_, then I don't use it.

In other words, I am not writing anything here that I wouldn't say during a chilled evening around the coffee table.
...
- High-effort in all image `alt` attributes.
