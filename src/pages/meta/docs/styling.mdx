...
Although I am using atomic design nomenclature in these docs, I decided to drop these from the components or tokens. See [Conventions: atomic semantics](/meta/records/rejected/conventions-structure-atomic-semantics) to know why.
