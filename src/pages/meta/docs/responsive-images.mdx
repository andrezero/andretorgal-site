...
Image generation is handled by `@astrojs/image`, wrapped in a custom component + some hacks for more detailed content and better semantics, and the image optimisation is carefully synchronised with the layout. Aspect ratio awareness is mandatory to eliminate CLS.

</Abstract>

**
:** Because things are very responsive and fluid around here:
