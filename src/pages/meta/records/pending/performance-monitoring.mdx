...
I have been benchmarking continuously while building this website. Not too worried as [building with Astro is delivering on the promise](/meta/records/current/build-with-astro). But I noticed how my [previous site](/posts/2023-01/saying-goodbye-to-my-react-static-website)'s Lighthouse score was degrading for 3 years. Everything grows and evolves, so I will want to monitor my website's performance.
...
![Screenshot of Lighthouse report: 98 performance, 100 best practices, 100 SEO](./_media/lighthouse-20-Jan-2023.png)
