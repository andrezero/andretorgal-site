...
Replaced with [css](/meta/records/current/styling-css) since [React Static](/meta/records/rejected/react-static) was replaced with [Astro](/meta/records/current/build-with-astro).
