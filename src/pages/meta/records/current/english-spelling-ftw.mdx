...
Stick to :uk: _English_, use a spelling extension.
...
:exploding*head: everyone but Cambridge seems to think that trade-off should be spelled \_trade-off* and not _tradeoff_:
