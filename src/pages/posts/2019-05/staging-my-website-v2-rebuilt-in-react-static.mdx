...
![Screenshot of the Edit Origin screen at AWS S3 that asks the user to provide an origin](./media/do-not-pick-one-from-the-list.jpg 'Tip: do not pick one from the list, just type it manually')
...
![Screenshot of an ugly 403 error](./media/fugly-four-o-three.jpg "Of course, it didn't work")
...
![Screenshot of the next version of my website](./media/andretorgal-com-next.png 'Plenty of features to come')
