...
![Up close photo of a small waterfall in a very green and natural scenario](./media/waterfall-in-forest.jpg 'Thought you might need something fresh now // Photo by Ray Bilcliff on Pexels https://www.pexels.com/photo/waterfall-in-forest-waterfall-in-forest-5037136/')
...
It's a pain to have to type in all my blog posts that they are `type: post` or that they use `layout: ../~/t~/templatePost.astro`. :nauseated_face: Lame, time waster, error prone.
