...
```
![alt](./file.png "Title // Attribution http://source...")
```

![Up close photo of a small waterfall in a very green and natural scenario](./media/waterfall-in-forest.png 'Though you might need something fresh now // Photo by Ray Bilcliff on Pexels https://www.pexels.com/photo/waterfall-in-forest-waterfall-in-forest-5037136/')
...
External links must show an [arrow](https://en.wikipedia.org/wiki/Arrow) :point_left: decoration to help users know if they're leaving my site... Oh no! don't leave! Come back!
...
I might have to to dig into VSCode extensions as well.
