...
Since this website is [built with Astro](/posts/2023-01/building-my-website-with-astro-mdx-preact), and because Astro uses the Unified.js ecosystem for all things Markdown and MDX, I added `remark-emoji` and `remark-a11y-emoji` to the [configuration](https://github.com/andrezero/andretorgal-site/blob/main/astro.config.mjs).

And the build now replaces
...
![Screenshot of the unified website with the headline Content as structured data](./unified-js-website.png 'The unified-js-website is gorgeous')
