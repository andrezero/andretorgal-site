...
hero:
  src: ./_media/dog-3.jpg
  alt: Close up photo of a dog facing the camera. Only the eyes and top of its head is visible
  title: No relation, just a cute dog.
thumb: ./_media/dog-6.jpg
tags:
  - design-systems
...
In an attempt to break down the conversation around design systems in more concise posts, here's the one where I am listing benefits and direct and indirect impacts of design systems in organisations.
...
![Diagram of design system fundamental elements: principles, foundations, and patterns on the right](./_media/design-system-building-blocks.png)
...
![Close up photo of a dog facing the camera.](./_media/dog-3.jpg)
...
>
> [State of brand consistency report](https://info.marq.com/resources/report/brand-consistency) (paywall :key:)
...
!["The eight lean production wastes: Defects, over-production, waiting, unused talent, over-processing, transportation, motion, inventory"](./_media/design-system-waste-reduction.png 'Types of production waste')
...
![Close up photo of a dog facing the camera.](./_media/dog-5.jpg)
...
![Close up photo of a dog facing the camera.](./_media/dog-6.jpg)
...
![Depiction of two classic project management triangles: the one before the investment is smaller than the one after the investment](./_media/design-systems-shift-constraints.png 'More room to maneuver')
...
![Close up photo of a dog facing the camera.](./_media/dog-7.jpg '// Photo by Goochie Poochie on Pexel https://www.pexels.com/photo/shih-tzu-photo-on-studio-shot-3361739/')
