...
hero:
  src: ./_media/ai-design-system.jpg
  alt: An AI interpretation of what design system component gallery sheet looks like, with very little detail, with a the sheet looks like in its slick dark theme with red and white elements.
  title: Design System component gallery according to an AI image generator
tags:
  - design-systems
...
Typical definitions of _design system_ define the concept by what you can usually find in the systems, some times also hinting at a purpose of improving "consistency" and "efficiency".
