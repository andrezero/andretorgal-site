...
type: post
title: 'Static site generators: brief history, as I recall it'
tags:
  - ssg
  - content-management
...
Hype keeps building up around static site generators. But this technique has been around for much longer than most people think. Our industry's collective memory :brain: is very short, and it some times needs a little help.
...
![Photo of a hand holding a hammer](./_media/hammer-by-leo-moko.jpg 'The hammer & nail quote comes later. // Photo by Leo Moko on Unsplash https://unsplash.com/photos/B4YHKz6lLrQ')
...
![Stock photo of a hammer lightly touching a chicken egg](./_media/hammer-and-egg-pixabay.jpg '// Photo from Pixabay https://pixabay.com/photos/weakness-hammer-crush-egg-eggshell-314401/')
...
There has never been a more _exciting time to develop for the web_. We have the codebase, the tools, and the infrastructure to design, develop, and deploy faster, better than ever. And also options: modern SPAs, dynamic SSR, isomorphic rendering, serverless architectures, and more recently (joking! :sweat_smile:) SSG.

![Photo of hundreds of DYI tools neatly organised](./_media/tools-by-cesar-carlevarino-aragon.jpg '// Photo by Leo Moko on Unsplash https://unsplash.com/photos/NL_DF0Klepc')
