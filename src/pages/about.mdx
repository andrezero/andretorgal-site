...
<div tabIndex="-1" className="banner banner-contact" role="navigation">
  <ul className="nav-extenral">
    <li>
      <a className="email" href="mailto:info@andretorgal.com">
        Email
      </a>
    </li>
    <li>
      <a className="github" href="https://github.com/andrezero">
        Github
      </a>
    </li>
    <li>
      <a className="linkedin" href="https://linkedin.com/in/andretorgal">
        Linkedin
      </a>
    </li>
  </ul>
